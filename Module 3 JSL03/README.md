...
link to my loom video:https://www.loom.com/share/e99e080827c24e2da5548b8d44bb0fcc?sid=2281ecd5-cbc7-4a85-ae4a-7d64bd8a02be

Reflection on JSL03

Summary on example 2: Declarative. 
In summary,the cooksteak function employs declarative programming by defining the desired outcomes and using simple
data structures and high-level abstractions to manage the cooking process. It focuses on what needs to be done rather than
how each step should be executed.

Summary on example 1: Imperative
In this imperative approach,the function specifies the exact seequence of operations required to cook a steak, detailing
how each step should be performed.By defining constants, creating a structured process, and using loops and conditionals, 
the function provides a clear set of instructions that guide the user through the cooking process, focusing on the sequence of actions and the mutable states of the process. 